...
Motor and purification remain OFF
...
Motor runs for a predefined fixed time
...
ESP32 detects unsafe conditions remotely

Instant alert/notification is sent to the user
...
Arduino analyzes data using predefined thresholds
